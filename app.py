...
# This is set page config in this project.
def set_page_config():
    st.set_page_config(
        page_title="INDUSTRIAL COPPER MODELING",
        page_icon="https://uxwing.com/wp-content/themes/uxwing/download/banking-finance/piggy-saving-icon.png",
        layout="wide",
...
st.markdown("<h1 style='text-align: center; color: #46c5db;'>INDUSTRIAL COPPER MODELING</h1>", unsafe_allow_html=True)
...
# Scound page in Price Prediction
if selected=='PRICE PREDICTION':
        ...
        st.write(
            '##### ***<span style="color:#16b5a5">Fill all the fields and Press the below button to view the :red[predicted price]   of copper</span>***',
            unsafe_allow_html=True)
...
if selected == 'STATUS':
    ...
    st.write('#### ***<span style="color:#c2720a">Fill all the fields and press the below button to view the status :red[WON / LOST] of copper in the desired time range</span>***',unsafe_allow_html=True)
